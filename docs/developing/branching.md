...
commit, and puts the working tree back on an up-to-date `main`. It refuses
a PR whose checks fail, or that has none. Passing a number merges a PR other
than the current branch's — a dependabot bump, for instance.
