...
launch it. The launch method is not optional: run the bare binary and every
sample comes back zero, because the microphone grant lands on the terminal
rather than on ambient. The page explains the signed bundle before anything
else.
